...
set "JETTY_BASE=%FUSION_HOME%\jetty\connectors"
set "LOG_DIR=%FUSION_HOME%\logs\connectors"
...
@REM --------------------------------------------------------------------------------------
:do_start
START "%FUSION_SERVICE_NAME%" /D"%FUSION_HOME%" "%JAVAW%" -cp "%FUSION_HOME%\connectors\conf" -server -Xss256k %JAVA_OPTIONS% ^
