...
set "LOG_DIR=%FUSION_HOME%\logs\spark-master"
set FUSION_SERVICE_NAME=Fusion Spark Master
set APP_NAME=spark-master
set "APP_DIR=%FUSION_HOME%\apps\spark-master"
...
@REM --------------------------------------------------------------------------------------
:do_start
set "SPARK_MASTER_OPTS=!JAVA_OPTIONS! -Dcurator.zk.connect=%FUSION_ZK%  -Dlog4j.configurationFile=file:"%APP_HOME%\log4j2.xml"
...
set "SPARK_MASTER_OPTS=%SPARK_MASTER_OPTS%  -Dapollo.home=%FUSION_HOME% -Dspark.home=%SPARK_HOME%"

START "%FUSION_SERVICE_NAME%" /D"%FUSION_HOME%" "%APP_HOME%\bin\spark-master.bat" %SPARK_MASTER_OPTS%
