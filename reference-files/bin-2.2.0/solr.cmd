...
@REM --------------------------------------------------------------------------------------
set SERVICE_PORT=%SOLR_PORT%
set /A STOP_PORT=%SERVICE_PORT% - 1000

set "JETTY_BASE=%FUSION_HOME%\apps\jetty\solr"
set "LOG_DIR=%FUSION_HOME%\var\log\solr"
set "VAR_DIR=%FUSION_HOME%\var\solr"
set FUSION_SERVICE_NAME=Fusion Solr
...
set "JAVA_OPTIONS=%JAVA_OPTIONS% !GC_TUNE! %GC_LOG_OPTS%"
...
@REM --------------------------------------------------------------------------------------
@REM Start the Fusion Solr service
@REM --------------------------------------------------------------------------------------
:do_start
...
-Djetty.port=%SERVICE_PORT% ^
-DzkHost=%FUSION_SOLR_ZK% ^
-Dsolr.solr.home="data\solr" ^
-Dsolr.install.dir="%FUSION_HOME%\apps\solr-dist" ^
