...
@REM --------------------------------------------------------------------------------------
set SERVICE_PORT=%UI_PORT%
set /A STOP_PORT=%SERVICE_PORT% - 1000

set "JETTY_BASE=%FUSION_HOME%\apps\jetty\ui"
set "LOG_DIR=%FUSION_HOME%\var\log\ui"
set "VAR_DIR=%FUSION_HOME%\var\ui"
set FUSION_SERVICE_NAME=Fusion UI
set APP_NAME=ui
set "APP_DIR=%JETTY_BASE%\webapps\root"

set "JAVA_OPTIONS=-Djava.net.preferIPv4Stack=true -Xmx512m -XX:MaxPermSize=256m -Dapple.awt.UIElement=true"

REM if no FUSION_CORS_ALLOW_ORIGIN is defined, default to no origins (i.e. most restrictive).
IF NOT DEFINED FUSION_CORS_ALLOW_ORIGIN set "FUSION_CORS_ALLOW_ORIGIN=^$"
...
@REM --------------------------------------------------------------------------------------
@REM Start the Fusion UI service
@REM --------------------------------------------------------------------------------------
:do_start
START "%FUSION_SERVICE_NAME%" /D"%FUSION_HOME%" "%JAVAW%" -server -d64 %JAVA_OPTIONS% ^
